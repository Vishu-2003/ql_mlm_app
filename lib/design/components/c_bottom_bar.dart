...
///
/// When used as [CupertinoTabScaffold.tabBar], by default [CBottomBar] has
...
///
/// {@tool dartpad}
/// This example shows a [CBottomBar] placed in a [CupertinoTabScaffold].
///
...
/// See also:
///
///  * [CupertinoTabScaffold], which hosts the [CBottomBar] at the bottom.
///  * [BottomNavigationBarItem], an item in a [CBottomBar].
///  * <https://developer.apple.com/design/human-interface-guidelines/ios/bars/tab-bars/>
class CBottomBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  /// The height of the [CBottomBar].
  ///
  /// Defaults to 50.0. Must not be null.
  final double height;

  /// The border of the [CBottomBar].
  ///
                  ...
                  child: GestureDetector(
                    ...
                    child: Padding(
                      padding: EdgeInsets.only(
                        bottom: 4.0,
                        left: index == 2 ? 30.0 : 0.0, // ! Line Added
                        right: index == 1 ? 30.0 : 0.0, // ! Line Added
                      ),
                      child: Column(
  ...
  /// Create a clone of the current [CBottomBar] but with provided
